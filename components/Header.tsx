...
import amazonLogo from "../public/eco.png";
...
import { getCart } from '../redux/cardSlice';
            ...
            <div className='bg-[#131921] text-white py-1'>
                <div className='flex items-center justify-between w-[90%] mx-auto'>
                    ...
                    <div className='flex items-center w-[60%]'>
                        ...
                        type="text" 
                        className='w-full p-2 rounded-l-md outline-none text-black' placeholder='Search Items' />
                        <div 
                        onClick={searchHandler}
                        className='bg-[#2ecc71] p-2 cursor-pointer hover:bg-[#2ecc71]   rounded-r-md'>
                            <CgSearch size={"24px"} className='text-green-300' />
                        </div>
                    </div>
            ...
            <div className='bg-[#232F3E] w-full text-white p-2  flex justify-between items-center'>
                ...
                <div className='mr-5'>
                    <h1 onClick={ async ()=>{
                        ...
                        router.push("/signin");
                    }} className='text-[#2ecc71] font-bold cursor-pointer hover:underline  ' >Sign out</h1>
                </div>
            </div>
