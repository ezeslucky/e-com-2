...
import { clearAllCart, decrementQuantity, incrementQuantity, removeFromTheCart } from '../redux/cardSlice';
                        ...
                        <div key={product.id} className='py-4 flex justify-between  border-b border-gray-200'>
                            <div className='flex'>
                                ...
                                <div className='ml-4'>
                                    ...
                                    <div className='flex text-xl my-4 font-medium justify-between items-center w-fit bg-[#1abc9c] rounded-md px-5 py-1'>
                                        <div
                                            onClick={() => {
